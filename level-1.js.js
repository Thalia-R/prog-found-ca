...
function whatIDontLike(answer) {
    console.log("I don't like " + answer);
}

whatIDontLike("shrimps");
...
function namesOfStudents(name) {
    students.push(name);
}

namesOfStudents("Thalia");
